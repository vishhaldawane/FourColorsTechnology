...
class ChemicalElement implements Comparable <ChemicalElement>
{
	...
	/*public int compareTo(ChemicalElement otherElement)
	{
		System.out.println("Comparing..."+atomicName+" with "+otherElement.atomicName);
		return atomicName.compareTo(otherElement.atomicName);
	}*/
	
	public int compareTo(ChemicalElement otherElement)
	{
		System.out.println("Comparing..."+atomicWeight+" with "+otherElement.atomicWeight);
		return Float.compare(atomicWeight, otherElement.atomicWeight);
	}
...
public class TreeSetTest {
	public static void main(String[] args) {
		...
		periodicTableSet.add(element1); //ROOT
